...
*
*  Descripción: 
*  Aplicativo que permite el ordenamiento de vehiculos usando el método sort, 
...
function ingresarNvoVehiculo(){
    ...
    console.log('cambiando a NO ordenado');
    ordenado = false;
...
function ordenarVehiculos(){    
    if (!ordenado){
        // incluir invocación sort para ordenar los vehiculos por su nombre
        bdVehiculos.sort(
            (a,b) => {return a.placa.localeCompare(b.placa)}
        );
        console.log('cambiando a ordenado');
        ordenado = true;
    }
