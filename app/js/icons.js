// =============================================================================
// icons.js — Iconos Lucide inline (https://lucide.dev) · MIT License
// =============================================================================
// Paths SVG vectoriales coherentes para reemplazar emojis de UI.
// Función helper: icon(name, size = 18) → string HTML.
// =============================================================================
...
(function (global) {
  const ICONS = {
    ...
    'cpu': '<rect width="16" height="16" x="4" y="4" rx="2"/><rect width="6" height="6" x="9" y="9"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/>',
    ...
    'theater-masks': '<path d="M16.5 22c.5-1 1.5-2 2-3 .5-1 1.5-2 1.5-4a8 8 0 0 0-16 0c0 2 1 3 1.5 4 .5 1 1.5 2 2 3"/><circle cx="9" cy="11" r="1"/><circle cx="15" cy="11" r="1"/>',
    'info': '<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>',
    'lightbulb': '<path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/>',
    'gift': '<rect width="20" height="14" x="2" y="7" rx="1"/><path d="M12 8v13"/><path d="M19 12v7H5v-7"/><path d="M7.5 8a2.5 2.5 0 0 1 0-5C11 3 12 7 12 7s1-4 4.5-4a2.5 2.5 0 0 1 0 5z"/>',
  ...
  function icon(name, size = 18, extraClass = '') {
    ...
    return `<svg class="${cls}" xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${paths}</svg>`;
  }

  global.Icons = { icon, ICONS };
